<%@ Page Language="c#" CodeBehind="DisEngagementStatusManagement.aspx.cs" AutoEventWireup="true" Inherits="Microsoft.Samples.ReportingServices.CustomSecurity.DisEngagementStatusManagement, Microsoft.Samples.ReportingServices.CustomSecurity" Culture="auto" UICulture="auto" %>
...
<html>
<head>
    <title>Dis Engagement Reference Management</title>
    ...
    <form id="Form1" method="post" runat="server">
        <table style="width: 100%;">
            <tbody>
                ...
                <tr>
                    <td>
                        <div id="dvGridDisEngagementStatus" style="padding: 10px; width: 100%;">
                            <asp:GridView ID="gvDisEngagementStatus" runat="server" CssClass="table" UseAccessibleHeader="True" GridLines="None"
                                AutoGenerateColumns="false" AllowPaging="true" ShowFooter="true"
                                OnPageIndexChanging="OnPagingDisEngagementStatus" OnRowEditing="EditDisEngagementStatus"
                                OnRowUpdating="UpdateDisEngagementStatus" OnRowCancelingEdit="CancelEditDisEngagementStatus"
                                PageSize="100">
                                <Columns>
                                    <asp:TemplateField HeaderText="DisEngagement Status">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDisEngagementStatus" runat="server"
                                                Text='<%# Eval("reason")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:Label ID="lblDisEngagementStatusEdit" runat="server"
                                                Text='<%# Eval("reason")%>'></asp:Label>
                                            <asp:HiddenField runat="server" ID="hdnDisEngagementStatusIdEdit" Value='<%# Eval("DisEngagementStatusId")%>' />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="PositiveReason">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPositiveReason" runat="server"
                                                Text='<%# Eval("PositiveReason")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:DropDownList Visible="True" Width="100px" ID="ddPositiveReason" runat="server">
                        ...
                        <div>
                            <asp:Label Visible="True" Style="width: 100%" ID="lblDisEngagementStatusError" runat="server" ForeColor="Red" Font-Size="Small" Font-Names="Verdana" Font-Bold="True">
                            </asp:Label>
                        </div>
                        <br />
                        <br />
