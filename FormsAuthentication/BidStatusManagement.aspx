<%@ Page Language="c#" CodeBehind="BidStatusManagement.aspx.cs" AutoEventWireup="true" Inherits="Microsoft.Samples.ReportingServices.CustomSecurity.BidStatusManagement, Microsoft.Samples.ReportingServices.CustomSecurity" Culture="auto" UICulture="auto" %>
...
<html>
<head>
    <title>Bid Status Management</title>
    ...
    <form id="Form1" method="post" runat="server">
        <table style="width: 100%;">
            <tbody>
                ...
                <tr>
                    <td>
                        <div id="dvGridBidStatus" style="padding: 10px; width: 100%;">
                            <asp:GridView ID="gvBidStatus" runat="server"  CssClass="table" UseAccessibleHeader="True" GridLines="None"
                                AutoGenerateColumns="false" AllowPaging="true" ShowFooter="true"
                                OnPageIndexChanging="OnPagingBidStatus" OnRowEditing="EditBidStatus"
                                OnRowUpdating="UpdateBidStatus" OnRowCancelingEdit="CancelEditBidStatus"
                                PageSize="100">
                                <Columns>
                                    <asp:TemplateField  HeaderText="Bid Status">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBidStatus" runat="server"
                                                Text='<%# Eval("BidStatus")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:Label ID="lblBidStatusEdit" runat="server"
                                                Text='<%# Eval("BidStatus")%>'></asp:Label>
                                            <asp:HiddenField runat="server" ID="hdnBidStatusIdEdit" Value='<%# Eval("BidStatusId")%>' />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Selected">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSelected" runat="server"
                                                Text='<%# Eval("Selected")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:DropDownList Visible="True" Width="100px" ID="ddSelected" runat="server">
                        ...
                        <div>
                            <asp:Label Visible="True" Style="width: 100%" ID="lblBidStatusError" runat="server" ForeColor="Red" Font-Size="Small" Font-Names="Verdana" Font-Bold="True">
                            </asp:Label>
                        </div>
                        <br />
                        <br />
